...
TextStyle defaultStyle = const TextStyle(color: grayColor, fontSize: 20.0);
TextStyle linkStyle = const TextStyle(color: primaryColor);

final TextTheme coofitTextTheme = TextTheme(
